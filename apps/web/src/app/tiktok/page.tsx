    ...
    <div style={{ minHeight: '100vh', background: '#0A0A0C', color: '#fff', fontFamily: sans }}>
      <div style={{ maxWidth: 1000, margin: '0 auto', padding: '32px 20px 60px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 32, alignItems: 'start' }}>
        ...
        <div>
          ...
          <div style={{ fontFamily: disp, fontSize: 12, fontWeight: 700, letterSpacing: '0.32em', color: NEON, textTransform: 'uppercase' }}>GOON Global · Social Commerce</div>
          ...
          <p style={{ fontSize: 15.5, color: 'rgba(255,255,255,0.72)', lineHeight: 1.6, marginTop: 16, maxWidth: 440 }}>
            A GOON <b style={{ color: '#fff' }}>opera a sua operação</b> de Social Commerce no TikTok de ponta a ponta.
            <b style={{ color: NEON }}> Não é mentoria</b> — a gente coloca a mão e faz vender por você.
          </p>
          ...
          <div style={{ marginTop: 22, display: 'flex', flexDirection: 'column', gap: 10 }}>
            {['Operação montada e tocada pela GOON', 'Lives, loja e tráfego rodando por você', 'Você não precisa aprender nada', 'Poucas vagas por mês — não fique de fora'].map(t => (
          ...
          {done ? (
            <div style={{ background: '#141418', border: `1px solid ${NEON}`, borderRadius: 16, padding: '32px 26px', textAlign: 'center' }}>
              ...
              <p style={{ color: 'rgba(255,255,255,0.65)', fontSize: 14.5, lineHeight: 1.55, marginTop: 10 }}>
                Nosso time da <b style={{ color: '#fff' }}>GOON Global</b> vai avaliar seu perfil e te chamar no <b style={{ color: NEON }}>WhatsApp</b>. As vagas são limitadas — fica de olho! 🚀
              </p>
            </div>
          ) : (
